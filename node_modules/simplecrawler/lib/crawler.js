...
Crawler.prototype.fetchQueueItem = function(queueItem) {
	...
	clientRequest = client.get(requestOptions,function(response) {
		...
		function processReceivedData() {
			...
			//console.log("--111111-stateData",requestOptions,stateData,resourceText)

			// Trong Vu - fix content html
			//crawler.emit("fetchcomplete",queueItem,responseBuffer.content,response);
		...
		function receiveData(chunk) {
			//console.log("------BODY:",chunk,requestOptions)
